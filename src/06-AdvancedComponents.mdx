...
## Subject Areas
1. **Typescript**: Rewrite your components in slick TS. Write Interfaces where needed and think about edgecases. Don't care about IE11, make it as awesome and future proof as possible.
2. **Testing**: Write unit-tests to make sure your component is still working as expected. You can of course always test yourself.
