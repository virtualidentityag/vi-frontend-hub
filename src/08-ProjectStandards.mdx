...
Document how to release on npm or vi artifactory
NO project should have npm packages served directly from github (only temporarily from vi github if waiting for pr to merge)
