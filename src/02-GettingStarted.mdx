...
http://manifest-dev.virtual-identity.com/ <br />
...
<strong>Every new frontend developer is able to implement components in our Biotope projects, in compliance with our VI standards</strong>

Which includes
<ul>
    <li>knowing our common standards and</li>
    <li>having mastered the technical basics</li>
</ul>
