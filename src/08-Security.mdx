...
Although many security issues in this list refer to the Backend it's important for any Frontend Developer to know at least the theory behind all those security issues.
