...
The security aspects of your project are just as important as performance and UX.
Although more security issues refer to the Backend it's important for any Frontend Developer to know at least the theory behind all those security issues.

A very good place to start is the free and open software security community: The [OWASP Foundation](https://www.owasp.org/).
